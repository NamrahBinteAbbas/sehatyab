...
from .db_utilities import query_value, query_rows
...
# -------------------- STATS --------------------
@doctor.get("/api/doctor/<int:doctor_id>/stats")
...
# -------------------- APPOINTMENTS (range) --------------------
@doctor.get("/api/doctor/<int:doctor_id>/appointments")
...
# -------------------- CALENDAR --------------------
@doctor.get("/api/doctor/<int:doctor_id>/calendar")
